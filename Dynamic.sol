...
1. The array is named numbers and initialized with values [100, 200, 300, 400].
2. The pushNumber function allows adding a new number (400) to the end of the array.
3. The updateNumber function modifies the third element of the array, setting it to 80.
4. The deleteNumber function removes the value at the third index of the array.
*/
